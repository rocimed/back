...
export class BebidasController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Crear una bebida en la base de datos',
    description: 'EndPoint que devuelve el objeto creado de una bebida',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Obtener todas las bebidas de la base de datos',
    description: 'EndPoint que devuelve una lista de objetos de bebidas',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Obtener una bebida por id de la base de datos',
    description: 'EndPoint que devuelve un objeto de bebida',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @Get('search/:nombre')
  @ApiOperation({
    summary: 'Buscar bebidas por nombre',
    description:
      'Devuelve una lista de bebidas cuyo nombre contiene el texto proporcionado',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Bebidas encontradas correctamente',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'No se encontraron bebidas',
  ...
  async findByName(@Res() response, @Param('nombre') nombre: string) {
    const resStatus = await this.bebidasService.findByName(nombre);
    if (resStatus.statusCode === HttpStatus.NOT_FOUND) {
      return response.status(HttpStatus.NOT_FOUND).json(resStatus);
    }
    return response.status(HttpStatus.OK).json(resStatus);
  ...
  @Patch(':id')
  @ApiOperation({
    summary: 'Actualizar una bebida por id de la base de datos',
    description: 'EndPoint que actualiza la información de una bebida',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Borrar una bebida por id de la base de datos',
    description: 'EndPoint que elimina una bebida de la base de datos',
  })
  @ApiResponse({
    status: HttpStatus.OK,
